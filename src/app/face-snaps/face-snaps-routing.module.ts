...
const routes : Routes = [
    ...
    {path:'', component:FaceAppListComponent, canActivate : [AuthGuard] },
    {path:'create/facesnaps', component:FaceAppListComponent, canActivate : [AuthGuard] },
...
export class FaceSnapsRoutinModule{
